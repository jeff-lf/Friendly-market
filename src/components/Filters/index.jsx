...
export const Filters  = () => {
    ...
    return (
        <Container>
            ...
            <div>
                <button className="SearchButton" onClick={() => filterProducts('Todos')}>
                    <div className='searchImg'><StorefrontIcon fontSize="large"/></div>
                    <span>Todos os produtos</span>
                </button>
                <button className="SearchButton" onClick={() => filterProducts('Esportes')}>
                    <div className='searchImg'><SportsVolleyballIcon fontSize="large"/></div>
                    <span>Esportes</span>
                </button>
                <button className="SearchButton" onClick={() => filterProducts('Brinquedos')}>
                <div className='searchImg'><SmartToyOutlinedIcon fontSize="large"/></div>
                    <span>Brinquedos</span>
                </button>
                <button className="SearchButton" onClick={() => filterProducts('Veiculos')}>
                ...
                <button className="SearchButton" onClick={() => filterProducts('Vestuario')}>
